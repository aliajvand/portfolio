---
company: Hackathon Pel 4 (هکتون پل ۴)
...
A 72-hour team hackathon run by AI Innovation Factory (کارخونه نوآوری هوش مصنوعی) with Jobama (جاباما), on demand forecasting for real hospitality booking data. Our team placed **2nd**.
